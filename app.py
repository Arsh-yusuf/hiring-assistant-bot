...
# from core.prompts import TECH_QUESTION_PROMPT

# # Initialize Cohere client
# co = cohere.Client(COHERE_API_KEY)

# # Define required candidate details (steps)
# steps = [
#     "Full Name",
#     "Email",
#     "Phone Number",
...
#     st.session_state.messages = []  # store full chat
...
#         "Step 1: Please provide your full name"
...
#             # Decide next bot reply
#             if st.session_state.step < len(steps):
#                 bot_reply = f"**Step {st.session_state.step+1}:** Please provide your **{steps[st.session_state.step]}**."
#             else:
...
#         # Show summary + questions if finished
#         if st.session_state.step == len(steps):
